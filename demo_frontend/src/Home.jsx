            ...
            <div className="relative shadow-xl sm:overflow-hidden sm:rounded-2xl">
              <div className="absolute inset-0">
                <img
                  ...
                  src="https://unsplash.com/photos/nOwkd4YvdUg/download?ixid=MnwxMjA3fDB8MXxhbGx8fHx8fHx8fHwxNjY4NjEzODU4&force=true&w=1920"
              ...
              <div className="relative px-4 py-16 sm:px-6 sm:py-24 lg:py-32 lg:px-8">
                <h1 className="text-center text-4xl font-bold tracking-tight sm:text-5xl lg:text-6xl">
                  <span className="block text-white">BUIDL Club</span>
                  <span className="block text-indigo-200">Learn, Build, Grow</span>
                </h1>
        ...
        <div className="mx-auto max-w-7xl px-4 pt-16 pb-8 sm:px-6 lg:px-8 lg:pt-24">
          <div className="mt-12 border-t border-gray-200 pt-8 md:flex md:items-center md:justify-between lg:mt-16">
            ...
            <p className="mt-8 text-base text-gray-400 md:order-1 md:mt-0">
              &copy; 2022 Web3 Growth Club. All rights reserved.
            </p>
          </div>
        </div>
      </footer>
